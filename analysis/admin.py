...
class PropertyImageAdmin(admin.ModelAdmin):
    ...
    list_filter = ('created_at', 'property', 'main_category', 'sub_category', 'room_type', 'condition_label')
    search_fields = ('property__url', 'original_url', 'main_category', 'sub_category', 'room_type', 'condition_label')
...
class GroupedImagesAdmin(admin.ModelAdmin):
    list_display = ('property', 'main_category', 'sub_category', 'image_count', 'created_at')
...
class AnalysisTaskAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('property', 'status', 'progress', 'stage')
        }),
        ('Stage Progress', {
