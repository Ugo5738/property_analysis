{
  ...
  'stages': {
    ...
    'merged_images': {
      'external_front_garden_space': ['/code/property_analysis/media/merged_property_images/merged_image_1_b0T4myI.jpg', '/code/property_analysis/media/merged_property_images/merged_image_2_LWcrfgI.jpg'],
      'internal_living_space': ['/code/property_analysis/media/merged_property_images/merged_image_3_gt0EjHG.jpg'],
      'internal_bedroom_space': ['/code/property_analysis/media/merged_property_images/merged_image_4_wnPu3yk.jpg'],
      'internal_kitchen_space': ['/code/property_analysis/media/merged_property_images/merged_image_5_CHL14fL.jpg'],
      'internal_bathroom_space': ['/code/property_analysis/media/merged_property_images/merged_image_6_AhkPEwr.jpg'],
      'others_others': ['/code/property_analysis/media/merged_property_images/merged_image_7_wzdBZnp.jpg'],
      'external_back_garden_space': ['/code/property_analysis/media/merged_property_images/merged_image_8_k8fwVKO.jpg']
    },
    'detailed_analysis': {
...

{
  ...
  'stages': {
    'download': {
      'successful_downloads': [289, 290, 291, 292, 293, 294, 295, 296, 297, 298, 299, 300, 301, 302, 303, 304],
      'failed_downloads': []
    },
    'initial_categorization': [
      {
      ...
      },
      {
        'category': 'internal',
        'details': {
          'room_type': 'kitchen_space'
        }
      },
      {
        'category': 'internal',
        'details': {
          'room_type': 'bathroom_space'
        }
      },
      {
        'category': 'internal',
      ...
      },
      {
        'category': 'external',
        'details': {
          'exterior_type': 'front_garden_space'
        }
      },
      {
        'category': 'internal',
      ...
      },
      {
        'category': 'external',
        'details': {
          'exterior_type': 'back_garden_space'
        }
      },
      {
        'category': 'external',
